...
{
    public partial class FlightDataCustom : MyUserControl
    {
        //Var Global
        ...
        public void Activate()
        {
            ...
            if (MainV2.getConfig("maplast_lat") != "")
            {
                try
                {
                    myGMAP1.Position = new PointLatLng(double.Parse(MainV2.getConfig("maplast_lat")),
                        double.Parse(MainV2.getConfig("maplast_lng")));
                   //setting zoom map awal doni
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            lblAltitudeValue.Text = MainV2.comPort.MAV.cs.ter_alt.ToString();
            lblGroundSpeedValue.Text = MainV2.comPort.MAV.cs.groundspeed.ToString();
